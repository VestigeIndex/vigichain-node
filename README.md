...
> **Note on synchronizing:** You do **not** need to start from genesis or provide manual anchor blocks. The node automatically discovers peers via DNS bootnodes, Tor v3 onion transport, or WebSocket relay, and catches up seamlessly. Just run it.
...
| `VIGI_BOOTNODES` | comma-separated peers, or `local` for a private lab | `seed-1.vigichain.org:28719,seed-2.vigichain.org:28719,seed-3.vigichain.org:28719` |
